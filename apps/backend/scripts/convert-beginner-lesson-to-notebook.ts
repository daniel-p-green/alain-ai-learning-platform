 ...
 * and save it under resources/content/notebooks/openai/gpt-oss-20b (metadata.json updated).
 *
...
async function main() {
  ...
  // Save under repo resources/content/… (go up one level from backend to repo root for save util)
