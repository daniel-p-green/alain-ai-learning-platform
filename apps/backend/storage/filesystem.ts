...
const STORAGE_ROOT = (() => {
  ...
  if (!resolved.includes('resources/content') && !existsSync(resolved) && existsSync(DEFAULT_STORAGE_ROOT)) {
...
class FileSystemStorage {
  ...
  async saveNotebook(
    ...
    // Create directory structure: resources/content/notebooks/{provider}/{model_id}/{difficulty}/{date}/
  ...
  async saveResearch(
    ...
    // Create directory structure: resources/content/research/{provider}/{model_id}/{type}/
