...
const OPTIMIZED_PROMPT_RAW = readFileSync(join(process.cwd(), 'resources/prompts/alain-kit/optimized/research.optimized.v1.txt'), 'utf-8');
const OPTIMIZED_PROMPT = OPTIMIZED_PROMPT_RAW.replace('{{MODEL_REFERENCE_OR_TEXT}}', TARGET_MODEL_URL).replace('{{SUBJECT}}', TARGET_MODEL_URL);
