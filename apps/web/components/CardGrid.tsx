  ...
  return (
    <section className="mx-auto max-w-7xl px-6 md:px-8 py-12">
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card title="Generate Manuals" cta={<Link className="inline-flex items-center h-10 px-4 rounded-[12px] border border-ink-100 bg-paper-0 text-ink-900" href="/generate">Open</Link>}>
        ...
        <Card title="Browse Notebooks" cta={<Link className="inline-flex items-center h-10 px-4 rounded-[12px] border border-ink-100 bg-paper-0 text-ink-900" href="/notebooks">Explore</Link>}>
          Explore curated manuals across providers with consistent patterns and clear outcomes.
        </Card>
