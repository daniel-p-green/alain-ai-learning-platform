...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Scan notebooks: content/notebooks/<provider>/<model>/<difficulty>/<date>/*
    ...
    // Scan lessons: content/lessons/<provider>/<model>/<date>/lesson_*.json
    ...
    // Scan research: content/research/<provider>/<model>/
